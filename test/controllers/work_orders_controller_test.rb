...
class WorkOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_order" do
    assert_difference('WorkOrder.count') do
      post work_orders_url, params: { work_order: { maintenance_request_id: @work_order.maintenance_request_id, motif: @work_order.motif, status: @work_order.status, user_id: @work_order.user_id } }
    end
  ...
  test "should update work_order" do
    patch work_order_url(@work_order), params: { work_order: { maintenance_request_id: @work_order.maintenance_request_id, motif: @work_order.motif, status: @work_order.status, user_id: @work_order.user_id } }
