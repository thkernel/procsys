...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { address: @station.address, city: @station.city, phone: @station.phone, ref: @station.ref, status: @station.status, user_id: @station.user_id } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { address: @station.address, city: @station.city, phone: @station.phone, ref: @station.ref, status: @station.status, user_id: @station.user_id } }
